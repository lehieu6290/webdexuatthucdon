...
<body>
	...
	<form action="xulythemmonan.php" method="POST">
		<table class="form">
			<tr>
				<td>Tên món ăn</td>
				<td><input type="text" name="tenmonan" autocomplete="off"></td>
			</tr>
			<tr>
				<td>Loại món ăn</td>
				<td>
					<select name="maloaimonan">
					<?php while ($row = $result_loaimonan->fetch_assoc()){ ?>
					<option value="<?php echo $row['ma_loai_mon_an'] ?>"><?php echo $row['ten_loai_mon_an'] ?></option>
					<?php } ?>
					</select>
				</td>
			</tr>
			...
			<tr>
				<td>Lượng calo</td>
				<td><input type="number" name="luongcalo" min="0" max="10000"></td>
			</tr>
			<tr>
				<td>Nguyên liệu</td>
				<td>
			...
			<tr>
				<td></td>
				<td>
					<input type="submit" name="themmonan" value="Thêm" class="submit">
